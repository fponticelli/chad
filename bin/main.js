...
var chad_Chad = function(svg) {
	...
	this.world.engine.create([thx_geom_d2_Circle.fromPoints(p1,p2)]);
	var incr = 1;
	thx_core_Timer.repeat(function() {
		var v = p1.get_x() + incr;
		p1.set_x(v);
...
thx_geom_d2__$Radius_Radius_$Impl_$.nearEquals = function(this1,p) {
	return thx_core_Floats.nearEquals(this1.get_coord(),p.get_coord());
};
...
thx_geom_d2__$Radius_Radius_$Impl_$.isNearZero = function(this1) {
	return thx_core_Floats.nearZero(this1.get_coord());
};

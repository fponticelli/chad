...
Boolean.main = function() {
	Boolean.create("squares",120,120,function(render) {
		var tmp;
		var bottomLeft = new thx_geom_d2_xy_PointXY(10,10);
		var topRight = new thx_geom_d2_xy_PointXY(100,100);
		tmp = [bottomLeft,topRight];
		var sq1 = tmp;
		var tmp1;
		var bottomLeft1 = new thx_geom_d2_xy_PointXY(0,0);
		var topRight1 = new thx_geom_d2_xy_PointXY(70,70);
		tmp1 = [bottomLeft1,topRight1];
		var sq2 = tmp1;
		var tmp2;
		var tmp3;
		...
		var tmp4;
		var tmp5;
		var this2 = thx_unit_angle__$Degree_Degree_$Impl_$._new(45);
		tmp5 = thx_unit_angle__$Radian_Radian_$Impl_$._new(this2 * 0.0174532925199433);
		var this1 = tmp5;
		tmp4 = this1;
		var angle = tmp4;
		tmp3 = t1.transform(thx_geom__$Matrix4x4_Matrix4x4_$Impl_$.rotationZ(angle));
		var t = tmp3;
		tmp2 = t.transform(thx_geom__$Matrix4x4_Matrix4x4_$Impl_$.translation(new thx_geom_d3_xyz_PointXYZ(30,0,0)));
		render.drawPath(thx_geom_shape__$Box_Box_$Impl_$.toPath(sq1).difference(tmp2.toPath()));
	});
};
...
var chad_render_canvas_MiniCanvasGraphics = function(mini,weightScale) {
	...
	var translateY = thx_geom__$Matrix4x4_Matrix4x4_$Impl_$.translation(new thx_geom_d3_xyz_PointXYZ(0,mini.height,0));
...
chad_render_canvas_MiniCanvasGraphics.prototype = {
	...
	,get_reverseCoords: function() {
		if(null == this.reverseCoords) {
			...
			var tmp;
			var topRight = new thx_geom_d2_xy_PointXY(this.mini.width,this.mini.height);

...
class OrthoNormalBasis {
	...
	public var v(default, null) : Vector3;
	public var u(default, null) : Vector3;
	public var plane(default, null) : Plane;
	public var planeOrigin(default, null) : Vector3;
	public function new(plane : Plane, rightvector : Vector3)
	{
	...
	public function to2D(vec3 : Vector3)
		return new Vector2(vec3.dot(u), vec3.dot(v));

	public function to3D(vec2 : Vector2)
	...
	public function transform(matrix4x4)
	{
		...
		var newplane = plane.transform(matrix4x4),
			...
			origin_transformed = new Vector3(0, 0, 0).transform(matrix4x4),
